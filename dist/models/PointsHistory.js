...
const PointsHistorySchema = new mongoose_1.Schema({
    userId: {
...
exports.default = mongoose_1.default.models.PointsHistory ||
    mongoose_1.default.model('PointsHistory', PointsHistorySchema);
